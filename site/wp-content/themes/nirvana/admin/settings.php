...
function cryout_setting_favicon_fn() {
	...
	//cryout_proto_field( $nirvanas, "", "", $nirvanas[''], '');
...
function cryout_setting_frontpage_fn() {
	...
	echo "<div><small>".__("Enable the presentation front-page. This will become your new home page. <br> If you want another page to hold your latest blog posts, choose 'Blog Template (Posts Page)' from Page Templates while creating or editing that page.","nirvana")."</small></div>";
...
function cryout_setting_frontposts_fn() {
	...
	echo "<input type='text' id='nirvana_frontpostscount' name='nirvana_settings[nirvana_frontpostscount]' size='3' value='";
 	...
 	echo "<div><small>".__("Enable to display latest posts on the presentation page, below the columns. Sticky posts are always displayed and not counted.","nirvana")."</small></div>";
} // cryout_setting_frontpage_fn()
...
global $nirvanas;
	...
	foreach($items as $item):
		...
		echo " value='1' id='single$item' name='nirvana_settings[nirvana_searchbar][$item]' type='checkbox' /> ".$itemsare[$i]."</label>";
	$i++;
	endforeach;
