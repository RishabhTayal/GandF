         ...
         <ul class="news-list">
            <?php if ( $maxitems == 0 ) : echo '<li>' . __( 'No news items.', 'nirvana' ) . '</li>'; else :
                    	...
                    	<li>
							...
							<span class="news-item-date"><?php _e('Posted on','nirvana'); echo $news_item->get_date(' j F Y, H:i'); ?></span><br />
                            <?php echo nirvana_truncate_words(strip_tags( $news_item->get_description() ),40,'...') ; ?>
